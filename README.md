...
Frontend engineer. 4+ years building systems that scale.

Currently focused on React, TypeScript, and design systems. I ship.

## Links

- **Portfolio**: [luisgomez.dev](https://luisgomez.dev/)
- **Email**: luisfgomezortiz@gmail.com
- **LinkedIn**: [luisgomez31](https://linkedin.com/in/luisgomez31)

## Stack

TypeScript · React · Next.js · Node.js · Tailwind · PostgreSQL · MongoDB
